 ...
 * @author Acer
 */
public class ViewDashboarAdmin extends javax.swing.JFrame {
    ...
    public ViewDashboarAdmin(Auth auth) {
        initComponents();
        this.setLocationRelativeTo(null);        
        this.auth = auth;
    }

    public ViewDashboarAdmin() {
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public ViewDashboarAdmin(String session, int username) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.auth = auth;
        nama = session;
    ...
    private void initComponents() {
        ...
        labelNama.setBounds(660, 240, 150, 50);
        ...
        btnDokter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/medical/record/assets/Group 26.png"))); // NOI18N
        ...
        btnPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/medical/record/assets/Group 24.png"))); // NOI18N
        ...
        btnPasien.setBounds(480, 380, 481, 250);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDashboarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDashboarAdmin().setVisible(true);
            }
        });
    }
